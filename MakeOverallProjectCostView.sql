SELECT p.ProjectName, p.StartDate, p.CompletionDate, p.AmountCharged, c.FirstName, c.LastName, c.Phone, c.Email, pc.DateUsed, pc.Quantity,
...
LEFT JOIN UnitOfMeasure um ON ci.UnitOfMeasureId = um.Id AND pc.DateUsed BETWEEN cpu.StartDate AND cpu.EndDate